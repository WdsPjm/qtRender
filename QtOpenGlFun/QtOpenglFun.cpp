...
void QtOpenglFun::buildShader(std::string &vertShaderPath, std::string &framShaderPath) {
    ...
    for(auto temp:mShaderTypes)
    {
        ...
        {
            vertPaht ="D:\\clionCode\\QtOpengl\\data\\shader\\vertexShader.vert";
            fragPaht = "D:\\clionCode\\QtOpengl\\data\\shader\\fragmentShader.frag";
            std::cout<<"load PICTUREFIX SHADER"<<std::endl;

        } else if(temp == SHADERTYPE::DISCARD)
        {
            vertPaht ="D:\\clionCode\\QtOpengl\\data\\shader\\DiscardVertShader.vert";
            fragPaht = "D:\\clionCode\\QtOpengl\\data\\shader\\DiscardfragmentShader.frag";
            std::cout<<"load DISCARD SHADER"<<std::endl;
        } else
        {
            vertPaht ="D:\\clionCode\\QtOpengl\\data\\shader\\DefaultvertexShader.vert";
            fragPaht = "D:\\clionCode\\QtOpengl\\data\\shader\\DefaultfragmentShader.frag";
        }
    }
